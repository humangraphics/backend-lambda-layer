...
1. Enable debug printin in javacpp, and run the application, being sure to exercise all code paths that load libraries.
2. Inspect the debug logs to find the libraries which are loaded and essential to the application.
